...
var wait_for_battle = false;
if (variable_struct_exists(step, "wait_for_battle")) {
	wait_for_battle = step.wait_for_battle && instance_exists(Battle_Manager);
}
